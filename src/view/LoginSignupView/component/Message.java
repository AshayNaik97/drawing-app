...
public class Message extends javax.swing.JPanel {
    ...
    public void showMessage(MessageType messageType, String message) {
        ...
        if (messageType == MessageType.SUCCESS) {
            // lbMessage.setIcon(new ImageIcon(getClass().getResource("/resources/imagesicon/success.png")));
        } else {
            // lbMessage.setIcon(new ImageIcon(getClass().getResource("/resources/imagesicon/error.png")));
        }
    }
