...
public final class FilesUtils {
    ...
    // public static Date FolderLastModifiedDateTime(String FilePath){
    //         Path folderPath = Paths.get(FilePath);
    //         try {
    //             BasicFileAttributes attrs = Files.readAttributes(folderPath, BasicFileAttributes.class);
    //             FileTime lastModifiedTime = attrs.lastModifiedTime();
    //             SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    //             String formattedDate = dateFormat.format(new Date(lastModifiedTime.toMillis()));
    //             System.out.println("Last modified date and time: " + formattedDate);
