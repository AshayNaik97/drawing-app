...
import model.service.ServiceMail;
...
import view.LoginSignupView.component.Message;
import view.LoginSignupView.component.PanelCover;
import view.LoginSignupView.component.PanelLoading;
import view.LoginSignupView.component.PanelLoginAndRegister;
import view.LoginSignupView.component.PanelVerifyCode;
...
public class Main extends javax.swing.JFrame {
    ...
    private HomeMain homemain = new HomeMain();
    private DrawingMain drawingmain = new DrawingMain();
    ...
    private void register() {
        ModelUser user = loginAndRegister.getUser();
        try {
            if (service.checkDuplicateUser(user.getUserName())==true) {
                showMessage(Message.MessageType.ERROR, "User name already exit");
            } else if (service.checkDuplicateEmail(user.getEmail())==true) {
    ...
    private void login() {
        ...
        try {
            ...
            if (user != null) {
                this.dispose();
                homemain.main(user,drawingmain);
            } else {
